...
class ProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Profile
        fields = [
            'id', 'user', 'username', 'first_name', 'last_name', 'file', 'location', 'tel',
            'description', 'working_hours', 'type', 'email', 'created_at', 'updated_at', 'uploaded_at'
        ]
        read_only_fields = ['id', 'user', 'type', 'created_at', 'updated_at', 'username', 'email', 'uploaded_at']
    ...
    def validate_first_name(self, value):
        ...
        if value and value.isdigit():
            raise serializers.ValidationError('First name cannot consist only of digits.')
        return value
    ...
    def validate_last_name(self, value):
        ...
        if value and value.isdigit():
            raise serializers.ValidationError('Last name cannot consist only of digits.')
        return value
    ...
    def validate_working_hours(self, value):
        ...
        """
        if value and len(value.strip()) < 2:
            raise serializers.ValidationError('Working hours must be at least 2 characters long.')
        return value
...
class ProfileUpdateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Profile
        fields = ['file', 'first_name', 'last_name', 'location', 'tel', 'description', 'working_hours', 'email']
